namespace Microsoft.AspNetCore.Components.QuickGrid.QuickGridCollection.Pagination
{
    public abstract class GridPagingBase : ComponentBase
    {
        ...
        /// </summary>
        /// <param name="pageIndex">L'index de la page à laquelle naviguer.</param>
        ...
        /// </summary>
        /// <returns>Un tableau d'entiers représentant les numéros de page répartis. 0 indique qu'il n'y a pas de numéro de page à cet indice.</returns>
