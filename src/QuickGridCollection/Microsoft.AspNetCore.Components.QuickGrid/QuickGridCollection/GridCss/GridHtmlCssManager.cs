    ...
    public class GridHtmlCssManager
    {
        ...
        protected virtual Dictionary<ClassHtml, string> InitializedClassCss()
        {
            return new()
            {
                ...
                { ClassHtml.Column_Sort_i, "" },
                { ClassHtml.Column_Sort_i_i_SortAsc, "sorting_ascending" },
                { ClassHtml.Column_Sort_i_i_SortDesc, "sorting_descending" },
                { ClassHtml.Column_Sort_i_i_Sortdefault, "sorting_default" },
                { ClassHtml.Column_Sort_i_i_SortNot, "" },
                { ClassHtml.Column_Options_i, "dropdown" },
                { ClassHtml.Column_Options_i_div_NoShow, "dropdown-content" },
                { ClassHtml.Column_Options_i_div_Show, "dropdown-content show" },
                { ClassHtml.Column_Options_i_i_ColumnOptionActive, "grid-option-Acteved" },
                { ClassHtml.Column_Options_i_i_ColumnOptionNotActive, "grid-option" },
                { ClassHtml.Column_Options_i_i_MenuFiltreActive, "grid-filter-Actived" },
                { ClassHtml.Column_Options_i_i_MenuFiltreNotActive, "grid-filter" },
                { ClassHtml.Column_Options_i_i_MenuAdvancedFilterActive, "grid-filter-advanced-Active" },
                { ClassHtml.Column_Options_i_i_MenuAdvancedFilterNotActive, "grid-filter-advanced" },
        ...
        protected virtual Dictionary<StyleCss, string> InitializedStyleCss()
        {
            return new()
            {
                ...
                { StyleCss.Column_Sort_i, "float:right" },
                { StyleCss.Column_Sort_i_i_SortAsc, "" },
                { StyleCss.Column_Sort_i_i_SortDesc, "" },
                { StyleCss.Column_Sort_i_i_Sortdefault, "" },
                { StyleCss.Column_Sort_i_i_SortNot, "" },
                { StyleCss.Column_Options_i, "" },
                { StyleCss.Column_Options_i_div_NoShow, "" },
                { StyleCss.Column_Options_i_div_Show, "" },
                { StyleCss.Column_Options_i_i_ColumnOptionActive, "" },
                { StyleCss.Column_Options_i_i_ColumnOptionNotActive, "" },
                { StyleCss.Column_Options_i_i_MenuFiltreActive, "" },
                { StyleCss.Column_Options_i_i_MenuFiltreNotActive, "" },
                { StyleCss.Column_Options_i_i_MenuAdvancedFilterActive, "" },
                { StyleCss.Column_Options_i_i_MenuAdvancedFilterNotActive, "" },
