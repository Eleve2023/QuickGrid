...
public class GridHtmlCssManager
{
    ...
    protected virtual Dictionary<CssClass, string> InitializedClassCss()
    {
        return new()
        {
            ...
            { CssClass.Grid_div_table_thead_tr_th_Default, "" },
            { CssClass.Grid_div_table_thead_tr_td_Start, "" },
            { CssClass.Grid_div_table_thead_tr_td_Center, "" },
            { CssClass.Grid_div_table_thead_tr_td_End, "" },
            { CssClass.Grid_div_table_thead_tr_td_Left, "" },
            { CssClass.Grid_div_table_thead_tr_td_Right, "" },
            { CssClass.Grid_div_table_tbody, "" },
            { CssClass.Grid_div_table_tbody_tr, "" },
            { CssClass.Grid_div_table_tbody_tr_td_Default, "" },
            { CssClass.Grid_div_table_tbody_tr_td_Start, "" },
            { CssClass.Grid_div_table_tbody_tr_td_Center, "" },
            { CssClass.Grid_div_table_tbody_tr_td_End, "" },
            { CssClass.Grid_div_table_tbody_tr_td_Left, "" },
            { CssClass.Grid_div_table_tbody_tr_td_Right, "" },
            ...
            { CssClass.Column_Options_div_NoShow, "dropdown-menu" },
            { CssClass.Column_Options_div_Show, "dropdown-menu show" },
    ...
    protected virtual Dictionary<CssStyle, string> InitializedStyleCss()
    {
        return new()
        {
            ...
            { CssStyle.Grid_div_table_thead_tr_th_Default, "text-align: justify;" },
            { CssStyle.Grid_div_table_thead_tr_td_Start, "text-align: start;" },
            { CssStyle.Grid_div_table_thead_tr_td_Center, "text-align: center;" },
            { CssStyle.Grid_div_table_thead_tr_td_End, "text-align: end;" },
            { CssStyle.Grid_div_table_thead_tr_td_Left, "text-align: Left;" },
            { CssStyle.Grid_div_table_thead_tr_td_Right, "text-align: right;" },
            { CssStyle.Grid_div_table_tbody, "" },
            { CssStyle.Grid_div_table_tbody_tr, "" },
            { CssStyle.Grid_div_table_tbody_tr_td_Default, "text-align: justify;" },
            { CssStyle.Grid_div_table_tbody_tr_td_Start, "text-align: start;" },
            { CssStyle.Grid_div_table_tbody_tr_td_Center, "text-align: center;" },
            { CssStyle.Grid_div_table_tbody_tr_td_End, "text-align: end;" },
            { CssStyle.Grid_div_table_tbody_tr_td_Left, "text-align: Left;" },
            { CssStyle.Grid_div_table_tbody_tr_td_Right, "text-align: right;" },
            ...
            { CssStyle.Column_Options_i, "float: right;" },
            { CssStyle.Column_Options_div_NoShow, "" },
            { CssStyle.Column_Options_div_Show, "" },
