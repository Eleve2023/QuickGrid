...
public partial class PropertyColumnC<TGridItem, TProp> : ColumnCBase<TGridItem>
{
    ...
    /// <summary>
    /// Reference to the last instance of <see cref="PropertyColumnC{TGridItem, TProp}.IsSortable"/> assigned to this variable.
    /// </summary>
    /// <summary xml:lang="fr">
    /// Référence à la  dernière instance de <see cref="PropertyColumnC{TGridItem, TProp}.IsSortable"/> assignée à cette variable.
    /// </summary>
    private bool lastIsSortable;
    ...
    protected override void OnParametersSet()
    {
        ...
        if (!IsNewProperty && lastIsSortable != IsSortable)
        {
            lastIsSortable = IsSortable;
            if (IsSortable)
            {
                AddSortingInColumn();
            }
